...
import { changeApproval, changeTazorStake } from "../../slices/StakeThunk";
...
function V1Stake({ oldAssetsDetected, setMigrationModalOpen, hasActiveV1Bonds }) {
  ...
  const onChangeStake = async action => {
    ...
    // await dispatch(
    //   changeTazorStake({ address, action, value: quantity.toString(), provider, networkID: chainID, version2: false }),
    // );
  };
