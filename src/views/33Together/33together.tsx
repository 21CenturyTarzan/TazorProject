...
const PoolTogether = () => {
  ...
  useEffect(() => {
    ...
    if (walletChecked) {
      dispatch(getPoolValues({ networkID: networkId, provider: provider, address: address }));
      dispatch(getRNGStatus({ networkID: networkId, provider: provider, address: address }));
    }
  }, [walletChecked]);
