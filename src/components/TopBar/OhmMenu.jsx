  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography className="ohm-menu-button-text">TAZOR</Typography>
      </Button>
                  ...
                  <Link href={`https://pancakeswap.finance/swap`} target="_blank" rel="noreferrer">
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                        <Trans>Buy tokens on PancakeSwap</Trans>
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      {OHM_ADDRESS && (
                        ...
                        >
                          ...
                          />
                          <Typography variant="body1">TAZOR</Typography>
                        </Button>
                      )}
                      {SOHM_ADDRESS && (
                        <Button
                          variant="contained"
                          color="secondary"
                          onClick={addTokenToWallet("TAZ", SOHM_ADDRESS, address)}
                        >
                          <SvgIcon
                            component={TazTokenImg}
                            viewBox="0 0 32 32"
                            style={{ height: "25px", width: "25px" }}
                          />
                          <Typography variant="body1">TAZ</Typography>
                        </Button>
                      )}
                      {/* {GOHM_ADDRESS && (
                        <Button
